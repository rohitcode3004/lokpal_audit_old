...
(function ($) {
  ...
  $.flexslider = function(el, options) {
    ...
    methods = {
      ...
      pausePlay: {
        setup: function() {
          var pausePlayScaffold = $('<div class="' + namespace + 'pauseplay"><a href="void(0);"></a></div>');
...
jQuery(document).ready(function(){
	...
	jQuery('#header-nav .cmf_lan .alink').click(function(){
		return confirm("Do you want to change the language?");		
	});
	
	// Append home caret image
	jQuery('#main-menu #nav li.menu-mlid-218 a').html('<i class="fa fa-home"></i>');
	jQuery('#main-menu #nav li.menu-mlid-2718 a').html('<i class="fa fa-home"></i>');

	// Append external link caret image
	jQuery('.dgft-wrapper ul.menu li a').append('<i class="fa fa-external-link"></i>');
	...
	jQuery("label[for='edit-field-start-date-value-min']").addClass('element-invisible');
	jQuery("label[for='edit-field-start-date-value-max-datepicker-popup-0']").text('Start Date');
...
jQuery("#main-menu ul.menu li").click(function (){
       jQuery("#main-menu ul.menu li").removeClass("hover");
