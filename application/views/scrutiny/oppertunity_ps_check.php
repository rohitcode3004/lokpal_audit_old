              ...
              <div class="panel-body">
                ...
                <div class="table-responsive">                          
                  <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                   ...
                   // echo  "<pre>";
                     // echo "@@@@";
                   // print_r($oppertunity_ps_priliminary_inq);
                       ...
                       // $agency_count = getOpscount($row->filing_no);
                        ...
                        ?>
                          ...
                          <td>
                            ...
                            <button class="btn btn-primary" type="submit" value="<?php echo $row->filing_no."||".$row->listing_date."||".$row->bench_id."||".$flag."||".$row->ordertype_code."||".$row->bench_no; ?>" name="filing_no" form="myForm">Details</button>
                          </td>
                        </tr>
                        <?php endforeach;
