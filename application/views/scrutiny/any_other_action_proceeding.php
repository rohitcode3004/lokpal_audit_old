...
?>
  ...
  <script language="javascript"> 
    ...
    $("#any_other_action_proceeding").validate({
    ...
    <div class="app-content">
      <div class="main-content-app">
        ...
        <div class="row">
          ...
          <form id="any_other_action_proceeding" class="form-horizontal" role="form" method="post" action='<?= base_url();?>scrutiny/any_other_action_proceeding'  name="ops_proceeding" enctype="multipart/form-data">
        <?php 
        ...
        <div class="panel panel-primary">
          ...
          <div class="row">
            ...
            <input type="hidden" value="<?php echo get_complaintno($filing_no); ?>" name="complaint_no">
              <input type="hidden" value="<?php echo $status_report_department; ?>" name="status_report_department">
            <input type="hidden" value="<?php echo $other_action_code; ?>" name="other_action_code">
              <input type="hidden" value="<?php echo $additional_documents; ?>" name="additional_documents">
            <input type="hidden" value="<?php echo $others_ordertype; ?>" name="others_ordertype">
            <div class="row">
