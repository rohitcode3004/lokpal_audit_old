...
?>
  ...
  <script language="javascript"> 
    ...
    messages: {
       ...
       order_upload:"Please upload the order",
    ...
    <div class="app-content">
      <div class="main-content-app">
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                            ...
                            <ul class="more-action">
                              <li><a href="<?php echo base_url(); ?>scrutiny/agency_report_chk/<?php echo $flag; ?>"class="previous" >&laquo; Back</a></li>
                            </ul>
                          </div>
        ...
        <?php if($recieved_from == 'A') { ?>
          <form id="registar_proceeding" class="form-horizontal" role="form" method="post" action='<?= base_url();?>scrutiny/action2'  name="registar_proceeding" enctype="multipart/form-data">
        <?php }
