            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <div class="table-responsive">                          
                  ...
                  //  echo  "<pre>";
                     // echo "@@@@";
                  // print_r($oppertunity_ps_priliminary_inq); die('@@@');
                       // $agency_data = count($oppertunity_ps_priliminary_inq);
                      foreach($oppertunity_ps_priliminary_inq as $row):
                       // $agency_count = getOpscount($row->filing_no);
                        ...
                        ?>
                          ...
                          <td>
                            ...
                            <input type="hidden" name="bench_id" value="<?php echo $row->bench_id; ?>">                         
                             <input type="hidden" name="ordertype_code" value="<?php echo $row->ordertype_code; ?>">
                               <input type="hidden" name="bench_no" value="<?php echo $row->bench_no; ?>">

                                <input type="hidden" name="status_report_department" value="<?php echo $row->status_report_department; ?>">
                                <input type="hidden" name="other_action_code" value="<?php echo $row->other_action_code; ?>">
                                <input type="hidden" name="additional_documents" value="<?php echo $row->additional_documents; ?>">
                                <input type="hidden" name="others_ordertype" value="<?php echo $row->others_ordertype; ?>">
                            <button class="btn btn-primary" type="submit" value="<?php echo $row->filing_no."||".$row->listing_date."||".$row->bench_id."||".$flag."||".$row->ordertype_code."||".$row->bench_no."||".$row->status_report_department."||".$row->other_action_code."||".$row->additional_documents."||".$row->others_ordertype; ?>" name="filing_no" form="myForm">Details</button>
                          </td>
                        </tr>
                        <?php endforeach;
