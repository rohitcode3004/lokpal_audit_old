    ...
    <div class="row">
        <div class="col-md-8">
            <div class="media title-padding">
                <img src="../assets/images/indian-emblem.png" style="float: left;    margin-top: 20px;">
        ...
        <div class="col-md-4 d-none d-sm-none d-md-block" id="dig_img">
            <img src="../assets/images/digital-india.png" class="img-fluid float-right dig-img-pad" alt="Digital India">
        </div>
    </div>
</div>
...
<ul class="nav navbar-nav">
    ...
    <li><a href="../e-filing/filing.php">Appeal Filing</a></li>
    <li><a href="../e-filing/docufile.php">Document Filing</a></li>
