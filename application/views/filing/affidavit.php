  ...
  <div class="row">
    <div class="col-md-12 mt-30">  
      ...
      //$complaint_no = '1000100100';
        ...
        echo '<h4 class="text-center">Please note the Diary no:<b>'.$filing_no.'</h4> <h4 class="text-center">Please quote the above diary no in all future communications.</h4>';
        }
