                  ...
                  <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                    ...
                    //  print_r($case_detail);
                      ...
                      <tr>
                        ...
                        <td><?php echo ($case_detail[$i]->summary ?? 'n/a'); ?></td>
                        
                     

                        <td><?php echo ($case_detail[$i]->serial_no ?? 'n/a'); ?></td>                      


                    <?php if($case_detail[$i]->order_upload ?? '' !=''){?>
                  <td><a href="<?php echo base_url();?><?php echo $case_detail[$i]->order_upload ?? ''; ?>" target="_blank" alt="">Show Uploaded order</a>
                  </td> 
                  <?php }
                  else {
                  ?> 
