        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">Lokpal</a>
                </div>
                ...
                <ul class="nav navbar-nav navbar-left navbar-top-links">
                    <li><a href="<?php echo base_url('admin/dashboard2'); ?>" target="_blank"><i class="fa fa-home fa-fw"></i> Website</a></li>
                </ul>
                ...
                <ul class="nav navbar-right navbar-top-links">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                            <i class="fa fa-user fa-fw"></i> <?php echo $user['username']; ?> <b class="caret"></b>
                        </a>
                ...
                <!-- /.navbar-top-links -->
                <?php include(APPPATH.'views/admin/templates/admin_sidebar.php'); ?>
            </nav>