          ...
          <form method="post" id="element_form2">
            ...
            <div class="modal-body mx-3">
              ...
              <div class="form-group">
                ...
                <input class="form-control " type="text" placeholder="Submenu name" name="submenuname" id="submenuname">
                <span id="submenuname_error" class="text-danger"></span>
              </div>

              <div class="form-group">
                <label>Url:</label>
                <input class="form-control " type="text" placeholder="url" name="url" id="url">
                <span id="url_error" class="text-danger"></span>
              </div>

              <div class="form-group">
                <label>Priority:</label>
                <input class="form-control " type="text" placeholder="priority" name="subpriority" id="subpriority">
                <span id="priority_error" class="text-danger"></span>
              </div>

              <div class="form-group">
                <label>Display:</label>
                <select type="text" class="form-control" name="subdisplay" id="subdisplay">
                  <option value="t">On</option>
                  <option value="f"> Off </option>
                </select>
                <span id="display_error" class="text-danger"></span>
