...
<html lang="en">
 ...
 <fieldset >      
   ...
   <form id="searchcase_status" class="form-horizontal" style="border: 1px solid #456073!important;" role="form" method="post" action='<?= base_url();?>bench/searchcase_status'  name="searchcase_status" enctype="multipart/form-data">
...
?>
 ...
 <div class="col-md-3">
      ...
      <div class="col-md-3">
        <label for="from"><span style="color: red;">*</span>Search by Complaint No/Year</label>     
             
         <input type="text" class="form-control" style="width:90%;" name="case_no_year" id="case_no_year" maxlength="10"  placeholder="">      
