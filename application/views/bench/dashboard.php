                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                              ...
                              if($flag == 'F')
                                echo 'New Complaints';
                              elseif($flag == 'I')
                                echo 'Complaints in which Preliminary Inquiry has been <strong>Accepted</strong>';
                              elseif($flag == 'V')
                                echo 'Complaints in which Preliminary Investigation has been <strong>Accepted</strong>';
                              else
