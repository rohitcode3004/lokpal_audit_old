            	...
            	<div class="col-md-8 col-sm-6 col-xs-8">
                    <ol class="breadcrumb">
                        <li><a href="<?php echo base_url(); ?>">Home</a></li>
                         <li class="active">Nature of Complaints </li>
                    </ol>
            	</div>
    ...
    <div class="container">
        <div class="row">
                	...
                	<div class="col-md-8"> 
                        ...
                        <p align="justify">Lokpal is an apex body to deal with cases of corruption at the national level. It has to enquire into allegations of corruption against public functionaries of Central government in a time bound manner. </p>

                        <p align="justify">Citizens are advised that other complaints related to pension, service related issues and public grievances should be addressed to the respective departments on the official portals or websites and not to the Lokpal, unless it is related to corruption issue. </p>

                         <p align="justify">Some of the portals with their link are:-</p>
                          <p align="justify">Pensioners Portal:- <a href="https://pensionersportal.gov.in/" target="_blank">https://pensionersportal.gov.in/</a></p>
                           <p align="justify">Public Grievance Redress and Monitoring System:- <a href="https://pgportal.gov.in/" target="_blank">https://pgportal.gov.in/</a></p>
