                                ...
                                <fieldset>
                                  <label>Username:</label>
                                   ...
                                   <!-- <div class="checkbox">
                                    ...
                                    <input class="btn btn-lg btn-success btn-block" type="submit" name="userloginSubmit" value="login"/>
                                </fieldset>
                            </form>
                        </div>
                        <div align="center">
                        <span>Login through otp? <a href="<?php echo base_url(); ?>user/register" style="color:dodgerblue">Click here</a></span>
                      </div>
                    </div>
                </div>
            </div>
